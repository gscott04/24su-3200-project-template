...
(18, 'Clyve', 'Ito', '37', '2017-02-08', '1', 40, 40, '8'),
(19, 'Verne', 'Obee', '39', '2008-02-18', '15', 28, 28, '35'),
(20, 'Andrea', 'Ito', '28', '2012-04-27', '1', 18, 18, '6'),
...
(26, 'Cam', 'Ito', '18', '2008-05-08', '1', 14, 14, '26'),
...
(44, 'Nature Photography', 'Capture the beauty of nature with waterproof cameras'),
(45, 'Relaxation Time', 'Enjoy quiet time in portable hammocks'),
(46, 'Outdoor Cooking', 'Learn to prepare meals in the great outdoors'),
(47, 'Leave No Trace', 'Learn about environmentally friendly camping practices'),
(48, 'Night Hike', 'Explore the campgrounds after dark with solar lanterns'),
(49, 'Mountain Trekking', 'Advanced hiking using trekking poles for stability'),
(50, 'River Crossing', 'Learn safe techniques for crossing rivers using dry bags'),
(51, 'Backcountry Water Management', 'Learn about finding and purifying water in the wild'),
(52, 'Bear Safety', 'Learn how to stay safe in bear country'),
(53, 'Emergency Signaling', 'Learn how to signal for help in emergency situations'),
(54, 'Campfire Cooking', 'Cook meals over a campfire or camping stove'),
(55, 'Water Conservation', 'Learn about water management and conservation techniques'),
(56, 'Fire Starting', 'Learn various methods to start a fire in wet conditions'),
(57, 'Knot Tying', 'Learn essential knots for camping and climbing'),
(58, 'Tool Use and Safety', 'Learn to safely use and maintain camping tools'),
(59, 'Comfortable Camping', 'Tips and tricks for a good nights sleep while camping'),
(60, 'Heat Management', 'Learn to stay cool in hot weather conditions'),
(61, 'Rainy Day Camping', 'Activities and skills for enjoyable camping in wet weather'),
(62, 'Outdoor Photography', 'Learn to take great photos while protecting your equipment'),
(63, 'Campsite Setup', 'Learn efficient and safe campsite setup techniques'),
(64, 'Kayaking Basics', 'Introduction to kayaking with inflatable kayaks'),
(65, 'Water Safety', 'Learn essential water safety skills and practices'),
(66, 'Fishing', 'Learn fishing techniques and regulations'),
(67, 'Stargazing', 'Identify constellations and celestial objects'),
(68, 'Astronomy Night', 'Observe planets and stars with a portable telescope'),
(69, 'Plant Identification', 'Learn to identify local plants and their properties'),
(70, 'Nature Journaling', 'Document your outdoor experiences in a waterproof notebook'),
(71, 'Camp Hygiene', 'Learn about maintaining cleanliness at the campsite'),
(72, 'Leave No Trace Camping', 'Practice environmentally friendly camping techniques'),
(73, 'Wilderness Tool Use', 'Learn to safely use and maintain a camping axe'),
(74, 'Outdoor Laundry', 'Learn how to wash and dry clothes while camping'),
(75, 'Outdoor Dining', 'Set up and enjoy meals in the great outdoors'),
(76, 'Campsite Hygiene', 'Learn about maintaining personal hygiene while camping'),
(77, 'Comfortable Camping', 'Tips for getting a good nights sleep outdoors'),
(78, 'Off-Grid Living', 'Learn about using portable power sources while camping'),
(79, 'Camp Coffee Brewing', 'Learn to make great coffee in the wilderness'),
(80, 'Rainy Day Activities', 'Fun group activities for wet weather days'),
(81, 'Campfire Stories', 'Share stories around the campfire'),
(82, 'Outdoor Cooking Skills', 'Learn knife skills for outdoor cooking'),
(83, 'Campfire Cuisine', 'Create flavorful meals using a portable spice kit'),
(84, 'Swimming and Water Activities', 'Enjoy water-based activities safely'),
(85, 'Summer Camping Comfort', 'Stay cool and comfortable while summer camping'),
(86, 'Wilderness First Aid', 'Learn basic first aid for outdoor emergencies'),
...
('Insect repellent clothing', '43'),
('Waterproof camera', '44'),
('Portable hammock', '45'),
('Cooking utensils set', '46'),
('Biodegradable soap', '47'),
('Solar-powered lantern', '48'),
('Trekking poles', '49'),
('Dry bags', '50'),
('Portable water filter', '51'),
('Bear spray', '52'),
('Emergency whistle', '53'),
('Camping stove and fuel', '54'),
('Collapsible water container', '55'),
('Waterproof matches', '56'),
('Paracord', '57'),
('Multitool', '58'),
('Camping pillow', '59'),
('Portable fan', '60'),
('Rain poncho', '61'),
('Waterproof phone case', '62'),
('Camping saw', '63'),
('Inflatable kayak', '64'),
('Life jacket', '65'),
('Fishing license', '66'),
('Star chart', '67'),
('Portable telescope', '68'),
('Field guide for local flora', '69'),
('Waterproof notebook', '70'),
('Portable camp sink', '71'),
('Biodegradable trash bags', '72'),
('Camping axe', '73'),
('Portable clothesline', '74'),
('Camping table', '75'),
('Portable camp shower', '76'),
('Camping cot', '77'),
('Portable power station', '78'),
('Camping coffee maker', '79'),
('Waterproof playing cards', '80'),
('Portable camping chair', '81'),
('Camping knife set', '82'),
('Portable spice kit', '83'),
('Camping towel', '84'),
('Portable camping fan', '85'),
('Camping first aid manual', '86'),
